...
class DataProcessor:
    ...
    @staticmethod
    def process_adding_data(strID, strTitle, strArtist, lstTbl):
        ...
        Args:
            ...
            lstTbl (list): 2D data structure (list of dicts) that holds the data during runtime
    ...
    @staticmethod    
    def process_deleting_data(intIDDel, lstTbl):
